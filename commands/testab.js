...
const btn = new disbut.MessageButton()
    ...
    message.channel.send(embed, row).then(msg=>{
      ...
      collector.on('collect', button=>{
        ...
        message.channel.send(`${message.author} hat mit <a:YES:879778582870761503>JA abgestimmt!`)
        }
